...
var WhatElse3 = React.createClass({
                    ...
                    <Image  resizeMode='contain'  style={{width:1024,height:743 }} source={require('./image/u5.png')}>
                        <View style={styles.content_main}>
                            ...
                            <View style={styles.content_main_right}>{/*右半部分*/}
                                <View style={styles.content_main_right_top}>
                                    <Text style={{fontSize:45,textAlign:'center' ,marginTop:140,}}>
                                        in the same boat(处境相同)
                                    </Text>
                                </View>
                                <View style={styles.content_main_right_middle}>
                                    <Image source={require('./image/boat_image_u34.png')}
                                           style={{width:500,height:350,marginLeft:100,marginTop:0}}/>
                                </View>
